<img src="banner.svg" alt="Victor Guminski. I build websites. HTML, CSS and JavaScript." width="100%">
...
real browser on every push and deployed with Cloudflare Pages. Alongside it I am
...
| Project | What it is |
| --- | --- |
| [victorguminski.com](https://github.com/victorguminski18/victorguminski18.github.io) | Vanilla HTML, CSS and JS, with light and dark mode, animations, security headers and browser tests on every push. |
